...
public class Sitaan {
    ...
    private void connection(){
        try {
            ...
            System.out.println("Error Found @connection Sitaan Class : " +e.getMessage());
        }
    ...
    public void fetchData(){
        try {
            ...
            System.out.println("Error Found @fetchData Sitaan Class : " + e.getMessage());
        }
    }
    
    public ResultSet getSitaan(){
        return response;
    }
